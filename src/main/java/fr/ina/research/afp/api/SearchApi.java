...
public class SearchApi {
    ...
    private com.squareup.okhttp.Call searchUsingGETCall(String lang, String wt, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, List<String> fl, Boolean c, String sort, String tz, String gap, String from, String to, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'lang' is set
        if (lang == null) {
            throw new ApiException("Missing the required parameter 'lang' when calling searchUsingGET(Async)");
        }
        
        // verify the required parameter 'wt' is set
        if (wt == null) {
            throw new ApiException("Missing the required parameter 'wt' when calling searchUsingGET(Async)");
        }
     ...
     */
    public Result searchUsingGET(String lang, String wt, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, List<String> fl, Boolean c, String sort, String tz, String gap, String from, String to) throws ApiException {
        ApiResponse<Result> resp = searchUsingGETWithHttpInfo(lang, wt, startat, size, q, fq, f, fl, c, sort, tz, gap, from, to);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Result> searchUsingGETWithHttpInfo(String lang, String wt, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, List<String> fl, Boolean c, String sort, String tz, String gap, String from, String to) throws ApiException {
        com.squareup.okhttp.Call call = searchUsingGETCall(lang, wt, startat, size, q, fq, f, fl, c, sort, tz, gap, from, to, null, null);
     ...
     */
    public com.squareup.okhttp.Call searchUsingGETAsync(String lang, String wt, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, List<String> fl, Boolean c, String sort, String tz, String gap, String from, String to, final ApiCallback<Result> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchUsingGETCall(lang, wt, startat, size, q, fq, f, fl, c, sort, tz, gap, from, to, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Result>(){}.getType();
