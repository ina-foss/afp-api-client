...
import fr.ina.research.afp.api.model.Error;
 ...
 * Search result error
 */
@ApiModel(description = "Search result error")
...
public class ErrorMapping   {
  ...
  public ErrorMapping error(Error error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ErrorMapping errorMapping = (ErrorMapping) o;
    return Objects.equals(this.error, errorMapping.error);
  }
