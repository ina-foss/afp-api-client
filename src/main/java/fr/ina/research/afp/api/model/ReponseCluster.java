...
public class ReponseCluster   {
  @SerializedName("cluster")
  private List<DocumentGroup> cluster = new ArrayList<DocumentGroup>();
  ...
  public ReponseCluster cluster(List<DocumentGroup> cluster) {
    this.cluster = cluster;
    return this;
  }

  public ReponseCluster addClusterItem(DocumentGroup clusterItem) {
  ...
  **/
  ...
  public List<DocumentGroup> getCluster() {
    return cluster;
  }

  public void setCluster(List<DocumentGroup> cluster) {
    this.cluster = cluster;
  }

  public ReponseCluster numFound(Long numFound) {
  ...
  **/
  ...
  public ReponseCluster status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ReponseCluster took(Long took) {
    this.took = took;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReponseCluster reponseCluster = (ReponseCluster) o;
    return Objects.equals(this.cluster, reponseCluster.cluster) &&
        Objects.equals(this.numFound, reponseCluster.numFound) &&
        Objects.equals(this.status, reponseCluster.status) &&
        Objects.equals(this.took, reponseCluster.took);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cluster, numFound, status, took);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReponseCluster {\n");
