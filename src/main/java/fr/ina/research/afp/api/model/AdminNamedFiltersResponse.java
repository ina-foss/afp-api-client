...
/**
 * AdminNamedFiltersResponse
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2022-06-23T14:46:12.287+02:00")
public class AdminNamedFiltersResponse   {
  @SerializedName("filters")
  private Map<String, Parameters> filters = new HashMap<String, Parameters>();

  @SerializedName("status")
  private Status status = null;

  public AdminNamedFiltersResponse filters(Map<String, Parameters> filters) {
    this.filters = filters;
    return this;
  }

  public AdminNamedFiltersResponse putFiltersItem(String key, Parameters filtersItem) {
  ...
  **/
  ...
  public Map<String, Parameters> getFilters() {
    return filters;
  }

  public void setFilters(Map<String, Parameters> filters) {
    this.filters = filters;
  }

  public AdminNamedFiltersResponse status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdminNamedFiltersResponse adminNamedFiltersResponse = (AdminNamedFiltersResponse) o;
    return Objects.equals(this.filters, adminNamedFiltersResponse.filters) &&
        Objects.equals(this.status, adminNamedFiltersResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filters, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminNamedFiltersResponse {\n");
