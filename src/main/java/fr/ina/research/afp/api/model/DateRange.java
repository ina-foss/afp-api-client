...
/**
 * The field range to search
 */
@ApiModel(description = "The field range to search")
...
public class DateRange   {
   ...
   * @return from
  **/
  @ApiModelProperty(example = "now-1M", required = true, value = "")
   ...
   * @return to
  **/
  @ApiModelProperty(example = "now", required = true, value = "")
  public String getTo() {
    return to;
  }
