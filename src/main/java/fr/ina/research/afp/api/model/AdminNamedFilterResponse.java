...
public class AdminNamedFilterResponse   {
  ...
  public AdminNamedFilterResponse filter(Parameters filter) {
    this.filter = filter;
    return this;
  }
  ...
  **/
  ...
  public Parameters getFilter() {
    return filter;
  }

  public void setFilter(Parameters filter) {
    this.filter = filter;
  }

  public AdminNamedFilterResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AdminNamedFilterResponse status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdminNamedFilterResponse adminNamedFilterResponse = (AdminNamedFilterResponse) o;
    return Objects.equals(this.filter, adminNamedFilterResponse.filter) &&
        Objects.equals(this.name, adminNamedFilterResponse.name) &&
        Objects.equals(this.status, adminNamedFilterResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, name, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminNamedFilterResponse {\n");
