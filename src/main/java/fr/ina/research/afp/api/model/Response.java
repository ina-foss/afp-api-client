...
import fr.ina.research.afp.api.model.ClusterElement;
import fr.ina.research.afp.api.model.Facet;
import fr.ina.research.afp.api.model.NewsDocument;
import fr.ina.research.afp.api.model.Status;
import fr.ina.research.afp.api.model.Topic;
...
/**
 * The response of object
 */
@ApiModel(description = "The response of object")
...
public class Response   {
  ...
  private List<ClusterElement> cluster = new ArrayList<ClusterElement>();

  @SerializedName("docs")
  private List<NewsDocument> docs = new ArrayList<NewsDocument>();

  @SerializedName("facets")
  private Map<String, List<Facet>> facets = new HashMap<String, List<Facet>>();
  ...
  public Response cluster(List<ClusterElement> cluster) {
    this.cluster = cluster;
    return this;
  }

  public Response addClusterItem(ClusterElement clusterItem) {
  ...
  **/
  ...
  public void setCluster(List<ClusterElement> cluster) {
    this.cluster = cluster;
  }

  public Response docs(List<NewsDocument> docs) {
    this.docs = docs;
    return this;
  }

  public Response addDocsItem(NewsDocument docsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<NewsDocument> getDocs() {
    return docs;
  }

  public void setDocs(List<NewsDocument> docs) {
    this.docs = docs;
  }

  public Response facets(Map<String, List<Facet>> facets) {
    this.facets = facets;
    return this;
  }

  public Response putFacetsItem(String key, List<Facet> facetsItem) {
  ...
  **/
  ...
  public Response mapping(Map<String, Map<String, Object>> mapping) {
    this.mapping = mapping;
    return this;
  }

  public Response putMappingItem(String key, Map<String, Object> mappingItem) {
  ...
  **/
  ...
  public Response maxScore(Double maxScore) {
  ...
  **/
  ...
  public Response numFound(Long numFound) {
  ...
  **/
  ...
  public Response took(Long took) {
    this.took = took;
    return this;
  }
  ...
  **/
  ...
  public Response topics(List<Topic> topics) {
    this.topics = topics;
    return this;
  }

  public Response addTopicsItem(Topic topicsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.cluster, response.cluster) &&
        Objects.equals(this.docs, response.docs) &&
        Objects.equals(this.facets, response.facets) &&
        Objects.equals(this.mapping, response.mapping) &&
        Objects.equals(this.maxScore, response.maxScore) &&
        Objects.equals(this.numFound, response.numFound) &&
        Objects.equals(this.status, response.status) &&
        Objects.equals(this.took, response.took) &&
        Objects.equals(this.topics, response.topics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cluster, docs, facets, mapping, maxScore, numFound, status, took, topics);
  }
