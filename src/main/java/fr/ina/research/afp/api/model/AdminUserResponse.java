...
import fr.ina.research.afp.api.model.SearchServerUserDetail;
...
public class AdminUserResponse   {
  ...
  @SerializedName("user")
  private SearchServerUserDetail user = null;
  ...
  **/
  ...
  public AdminUserResponse user(SearchServerUserDetail user) {
    this.user = user;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public SearchServerUserDetail getUser() {
    return user;
  }

  public void setUser(SearchServerUserDetail user) {
    this.user = user;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, adminUserResponse.status) &&
        Objects.equals(this.user, adminUserResponse.user);
  }
