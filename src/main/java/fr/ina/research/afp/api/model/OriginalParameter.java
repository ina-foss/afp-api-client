...
import fr.ina.research.afp.api.model.OriginalParameter;
...
/**
 * Query elementary parameter: example  json &lt;br&gt;   {    \&quot;name\&quot;: \&quot;country\&quot;,    \&quot;in\&quot;: [     \&quot;FRA\&quot;,     \&quot;DEU\&quot;    ]   }
 */
@ApiModel(description = "Query elementary parameter: example  json <br>   {    \"name\": \"country\",    \"in\": [     \"FRA\",     \"DEU\"    ]   }")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-07-19T17:17:54.807+02:00")
public class OriginalParameter extends Parameter  {
  @SerializedName("name")
  ...
  @SerializedName("$And$Or$In$Exclude$Contains$Mtl")
  private List<OriginalParameter> andOrInExcludeContainsMtl = new ArrayList<OriginalParameter>();

  public OriginalParameter name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public OriginalParameter fullText(Boolean fullText) {
  ...
  **/
  ...
  public OriginalParameter andOrInExcludeContainsMtl(List<OriginalParameter> andOrInExcludeContainsMtl) {
    this.andOrInExcludeContainsMtl = andOrInExcludeContainsMtl;
    return this;
  }

  public OriginalParameter addAndOrInExcludeContainsMtlItem(OriginalParameter andOrInExcludeContainsMtlItem) {
    this.andOrInExcludeContainsMtl.add(andOrInExcludeContainsMtlItem);
    return this;
  }

   /**
   * must contains an operand oneOf [and|or|in|exclude|contains|mlt]
   * @return andOrInExcludeContainsMtl
  **/
  @ApiModelProperty(example = "null", value = "must contains an operand oneOf [and|or|in|exclude|contains|mlt]")
  public List<OriginalParameter> getAndOrInExcludeContainsMtl() {
    return andOrInExcludeContainsMtl;
  }

  public void setAndOrInExcludeContainsMtl(List<OriginalParameter> andOrInExcludeContainsMtl) {
    this.andOrInExcludeContainsMtl = andOrInExcludeContainsMtl;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OriginalParameter parameter = (OriginalParameter) o;
    return Objects.equals(this.name, parameter.name) &&
        Objects.equals(this.fullText, parameter.fullText) &&
        Objects.equals(this.andOrInExcludeContainsMtl, parameter.andOrInExcludeContainsMtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, fullText, andOrInExcludeContainsMtl);
  }
  ...
  public String toString() {
    ...
    sb.append("    andOrInExcludeContainsMtl: ").append(toIndentedString(andOrInExcludeContainsMtl)).append("\n");
    sb.append("}");
    return sb.toString();
  }
}
