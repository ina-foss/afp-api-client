...
public class ReponseTopics   {
  ...
  public ReponseTopics numFound(Long numFound) {
  ...
  **/
  ...
  public ReponseTopics status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ReponseTopics took(Long took) {
    this.took = took;
    return this;
  }
  ...
  **/
  ...
  public ReponseTopics topics(List<Topic> topics) {
    this.topics = topics;
    return this;
  }

  public ReponseTopics addTopicsItem(Topic topicsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReponseTopics reponseTopics = (ReponseTopics) o;
    return Objects.equals(this.numFound, reponseTopics.numFound) &&
        Objects.equals(this.status, reponseTopics.status) &&
        Objects.equals(this.took, reponseTopics.took) &&
        Objects.equals(this.topics, reponseTopics.topics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numFound, status, took, topics);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReponseTopics {\n");
