...
public class ClusterApi {
    ...
    /* Build call for clusterUsingGET */
    private com.squareup.okhttp.Call clusterUsingGETCall(String lang, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, String tz, String gap, String from, String to, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'lang' is set
        if (lang == null) {
            throw new ApiException("Missing the required parameter 'lang' when calling clusterUsingGET(Async)");
        }
     ...
     * @param size The number of responses (optional, default to 1000)
     ...
     */
    public ReponseCluster clusterUsingGET(String lang, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, String tz, String gap, String from, String to) throws ApiException {
        ApiResponse<ReponseCluster> resp = clusterUsingGETWithHttpInfo(lang, startat, size, q, fq, f, tz, gap, from, to);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ReponseCluster> clusterUsingGETWithHttpInfo(String lang, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, String tz, String gap, String from, String to) throws ApiException {
        com.squareup.okhttp.Call call = clusterUsingGETCall(lang, startat, size, q, fq, f, tz, gap, from, to, null, null);
     ...
     */
    public com.squareup.okhttp.Call clusterUsingGETAsync(String lang, Integer startat, Integer size, List<String> q, List<String> fq, List<String> f, String tz, String gap, String from, String to, final ApiCallback<ReponseCluster> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = clusterUsingGETCall(lang, startat, size, q, fq, f, tz, gap, from, to, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ReponseCluster>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for clusterUsingPOST1 */
    private com.squareup.okhttp.Call clusterUsingPOST1Call(Parameters parameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = parameters;
        
        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling clusterUsingPOST1(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ReponseCluster clusterUsingPOST1(Parameters parameters) throws ApiException {
        ApiResponse<ReponseCluster> resp = clusterUsingPOST1WithHttpInfo(parameters);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ReponseCluster> clusterUsingPOST1WithHttpInfo(Parameters parameters) throws ApiException {
        com.squareup.okhttp.Call call = clusterUsingPOST1Call(parameters, null, null);
        Type localVarReturnType = new TypeToken<ReponseCluster>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
