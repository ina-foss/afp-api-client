...
public class LatestApi {
    ...
    /* Build call for latestUsingGET1 */
    private com.squareup.okhttp.Call latestUsingGET1Call(String lang, String wt, String tz, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'lang' is set
        if (lang == null) {
            throw new ApiException("Missing the required parameter 'lang' when calling latestUsingGET1(Async)");
        }
        
        // verify the required parameter 'wt' is set
        if (wt == null) {
            throw new ApiException("Missing the required parameter 'wt' when calling latestUsingGET1(Async)");
        }
     ...
     */
    public Result latestUsingGET1(String lang, String wt, String tz) throws ApiException {
        ApiResponse<Result> resp = latestUsingGET1WithHttpInfo(lang, wt, tz);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Result> latestUsingGET1WithHttpInfo(String lang, String wt, String tz) throws ApiException {
        com.squareup.okhttp.Call call = latestUsingGET1Call(lang, wt, tz, null, null);
     ...
     */
    public com.squareup.okhttp.Call latestUsingGET1Async(String lang, String wt, String tz, final ApiCallback<Result> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = latestUsingGET1Call(lang, wt, tz, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Result>(){}.getType();
