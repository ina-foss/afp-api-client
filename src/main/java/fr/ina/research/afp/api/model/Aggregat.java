 ...
 * A wanted facet
 */
@ApiModel(description = "A wanted facet")
...
public class Aggregat   {
  ...
  public Aggregat minDocCount(Integer minDocCount) {
   ...
   * @return minDocCount
  **/
  @ApiModelProperty(example = "null", value = "1")
  ...
  public Aggregat size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * @return size
  **/
  @ApiModelProperty(example = "null", value = "1000")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Aggregat aggregat = (Aggregat) o;
    return Objects.equals(this.minDocCount, aggregat.minDocCount) &&
        Objects.equals(this.size, aggregat.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minDocCount, size);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Aggregat {\n");
