...
public class ApiClient {
    ...
    private String basePath = "https://afp-apicore-prod.afp.com:443/";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://afp-apicore-prod.afp.com:443/
    ...
    public RequestBody serialize(Object obj, String contentType) throws ApiException {
        if (obj instanceof byte[]) {
            ...
            System.out.println("ApiClient serialize : " + content);
